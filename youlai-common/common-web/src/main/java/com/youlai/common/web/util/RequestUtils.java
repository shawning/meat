...
public class RequestUtils {
    ...
    public static String getAuthClientId() {
        ...
        // 从请求路径中获取
        clientId = request.getParameter(AuthConstants.JWT_CLIENT_ID_KEY);
        if (StrUtil.isNotBlank(clientId)) {
            return clientId;
        }

        // 从请求头获取
        String basic = request.getHeader(AuthConstants.JWT_TOKEN_HEADER);
        basic = request.getHeader(AuthConstants.JWT_TOKEN_HEADER);
